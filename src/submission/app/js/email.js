...
$(function() {
	...
	if (response == '-3') {
		ReHi.showError('Humph!', 'Your account has been disabled. <a href="mailto:martin.porcheron@nottingham.ac.uk" class="alert-link">I need help!</a>');
	} else if (response == '-1') {
		ReHi.showError('Woops!', 'Looks like you\'ve entered an invalid username/password combination. <a href="mailto:martin.porcheron@nottingham.ac.uk" class="alert-link">I need help!</a>'); 
	...
	ReHi.regSubForm($('form.stage-email'), 'do/email', function (response, textStatus, jqXHR) {
	if (response != '1') {
