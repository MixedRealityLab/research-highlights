				...
				<div class="row main">
					...
					<form class="stage stage-email collapse">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<p>You can use any of the following codes, these are substituted per user at email time: <?php $keys = ''; foreach ($oUserModel->substsKeys () as $key): $keys .= (empty ($keys) ? '' : ', ') . '<code>&lt;'. $key .'&gt;</code>'; endforeach; print $keys; ?>.</p>
							<hr>
						</div>
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="panel panel-primary">
...
$oPageTemplate->add ('javascript', URI_WEB . '/js/email.js');
